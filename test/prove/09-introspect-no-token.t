...
=== TEST 1: introspection path, no Authorization -> 401 + MCP-format WWW-Authenticate
--- http_config
    ...
    server {
        ...
        location / {
            ...
            return 200 '{"active":true,"sub":"u","scope":"mcp:read","aud":"http://localhost/mcp","exp":4133862000}';
        }
    }
--- config
