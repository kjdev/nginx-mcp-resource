...
=== TEST 1: introspection aud OK, scope insufficient -> 403 + insufficient_scope challenge
--- http_config
    ...
    server {
        ...
        location / {
            ...
            return 200 '{"active":true,"sub":"u","scope":"other:scope","aud":"http://localhost/mcp","exp":4133862000}';
        }
    }
--- config
    ...
    location /mcp {
        ...
        proxy_pass http://127.0.0.1:18146;
    }
...
WWW-Authenticate: Bearer error="insufficient_scope", scope="mcp:read", resource_metadata="http://localhost/\.well-known/oauth-protected-resource"
