...
=== TEST 1: valid signature but aud mismatch -> 401 + MCP-format WWW-Authenticate
--- http_config
    server {
        listen 18133;
...
GET /mcp
--- more_headers
Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6InRlc3QxIn0.eyJhdWQiOiJodHRwczovL290aGVyLmV4YW1wbGUuY29tIiwic2NvcGUiOiJtY3A6cmVhZCIsImV4cCI6NDEzMzg2MjAwMH0.12L5WbzGTF2V-7Nb0Bb3o98d_Pe0ZWoZ9iTwxfKu1ZM
--- error_code: 401
